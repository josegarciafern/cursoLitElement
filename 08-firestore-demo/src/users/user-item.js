...
export class UserItem extends LitElement {
    ...
    render() {
        return html`
            <section>
                <div class="userdata">
                    <span class="name">${this.user.nombre} ${this.user.email}</span>
                    <span class="born">${this.user.telefono}</span>
                </div>
                <div class="actions"> 
            ...
            ${this.showEdit
              ? html`<user-edit .user="${this.user}" @user-edit="${this.hideEdition}" @user-cancel="${this.hideEdition}"></user-edit>`
              : ''
            } 
        `;
    }
